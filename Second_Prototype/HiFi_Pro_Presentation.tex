...
\marginpar{%
	\begin{overpic}[width=\marginparwidth]
		...
		\put(-7,89){\framebox{1}}
		\put(-7,80){\framebox{2}}
		\put(62,80){\framebox{3}}
		\put(-7,70){\framebox{4}}
		\put(-7,54){\framebox{5}}
		\put(-7,39){\framebox{6}}
		\put(-7,23){\framebox{7}}
		\put(-7,9){\framebox{8}}
		\put(62,89){\framebox{9}}
	\end{overpic}
...
\marginpar{%
	\begin{overpic}[width=\marginparwidth]
		...
		\put(62,80){\framebox{1}}
		\put(-7,80){\framebox{2}}
		\put(62,47){\framebox{3}}
		\put(-7,8){\framebox{4}}
		\put(-7,89){\framebox{5}}
	\end{overpic}
...
\marginpar{%
	\begin{overpic}[width=\marginparwidth]
		...
		\put(-7,52){\framebox{3}}
		\put(-7,36){\framebox{4}}
		\put(27,17){\framebox{5}}
		\put(-7,89){\framebox{6}}
	\end{overpic}
	\captionof{figure}{The location selection screen}\label{fig:HiLocation}
}

The user can choose to search within a distance from their current
...
\begin{figure}[htbp]
	...
	\begin{subfigure}{0.45\textwidth}
		\begin{overpic}[width=\textwidth]
			...
			\put(62,81){\framebox{1}}
			\put(50,60){\framebox{2}}
			\put(-7,89){\framebox{3}}
		\end{overpic}%
		...
		\begin{minipage}{\linewidth}
			\begin{subfigure}[c]{0.44\textwidth}
				\begin{overpic}[width=\textwidth]
					...
					\put(-7,89){\framebox{1}}
					\put(-7,78){\framebox{2}}
					\put(61,78){\framebox{3}}
					\put(62,42){\framebox{4}}
					\put(62,8){\framebox{5}}
				\end{overpic}
				\captionof{figure}{The list results screen}\label{fig:HiList}
			\end{subfigure}
...
\paragraph{Map Results} (Figure~\ref{fig:HiMap})
