...
\begin{itemize}
	\item The option to filter by ``activity type'' in the search form is
		...
		\marginFig{img/relatedReviews/UoBTimetableDD}{Display when the 18:00 two hour slot is chosen. However, only one of two hours following 18:00 is available.}{fig:UoBTimetableDD}
...
% \end{figure}
\marginFig[0.8]{img/relatedReviews/AquaterraHome.png}{Aquaterra booking
homepage}{fig:AquaterraHome}
%\marginFig[0.8]{img/relatedReviews/AquaterraSobellHome.png}{Facilities
%available at Sobell Leisure Centre.}{fig:AquaterraSobellHome}
\marginpar{%
	\centering
	\setlength{\fboxsep}{0pt}%
	\fbox{\includegraphics[width=0.8\marginparwidth]{img/relatedReviews/AquaterraSobellHome.png}}
	\captionof{figure}{Facilities available at Sobell Leisure
	Centre.}\label{fig:AquaterraSobellHome}
}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{img/relatedReviews/LondonTennisSearch.png}
...
% \end{figure}
\marginFig{img/relatedReviews/LondonTennisPredict.png}{Drop down to predict
input when typing a name of a court.}{fig:LondonTennisPredict}
