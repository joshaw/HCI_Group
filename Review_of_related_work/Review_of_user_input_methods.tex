...
% \end{figure}
\marginFig[0.8]{img/relatedReviews/GoogleCalendarTimetable.png}{Google
Calendar's cramped calendar.}{fig:GoogleCalendarTimetable}
\marginFig[0.8]{img/relatedReviews/RedSpottedHankyTicketSelection}{RedSpottedHanky
displays dates more clearly.}{fig:RedSpottedHankyTicketSelection}
...
% \marginFig{img/relatedReviews/iOSDateTime}{RedSpottedHanky}{fig:iOSDateTime}
...
% \marginFig{img/relatedReviews/iOS7DateTime}{Google Calendar}{fig:iOS7DateTime}
\begin{figure}[htbp]
	\centering
...
\marginFig[0.8]{img/relatedReviews/TescoFormInput}{Large, easy to access text
entry}{fig:TescoFormInput}
...
\marginFig[0.8]{img/relatedReviews/PaintCalculatorCrowded}{Crowded interfaces
make entry more difficult.}{fig:PaintCalculatorCrowded}
