...
% \end{figure}
\marginFig[0.7]{img/relatedReviews/GoogleCalendarTimetable.png}{Google
Calendar's cramped calendar.}{fig:GoogleCalendarTimetable}
\marginFig[0.7]{img/relatedReviews/RedSpottedHankyTicketSelection}{RedSpottedHanky
...
\marginFig[0.7]{img/relatedReviews/TescoFormInput}{Large, easy to access text
...
\marginFig[0.7]{img/relatedReviews/PaintCalculatorCrowded}{Crowded interfaces
