...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/SkyscannerFig1.png}
        \caption{Home screen}
    \end{subfigure}%
    \qquad
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/SkyscannerFig2.png}
        \caption{Results screen}
    \end{subfigure}
    \caption{Skyscanner screens (caption needed?)}\label{fig:skyscanner1}
\end{figure}

%SkyscannerFig1.png (home screen) ; SkyscannerFig2.png (results screen)
...
\begin{figure}[ht]
        \centering
        \begin{subfigure}[b]{0.2\textwidth}
            \includegraphics[width=\textwidth]{img/SkyscannerFig3.png}
            \caption{Calendar}\label{fig:skyscannerfig3}
        \end{subfigure}
        \qquad
        \begin{subfigure}[b]{0.2\textwidth}
            \includegraphics[width=\textwidth]{img/SkyscannerFig4.png}
            \caption{Filter options}\label{fig:skyscannerfig4}
        \end{subfigure}
        \qquad
        \begin{subfigure}[b]{0.2\textwidth}
            \includegraphics[width=\textwidth]{img/SkyscannerFig5.png}
            \caption{Alternative dates}\label{fig:skyscannerfig5}
        \end{subfigure}
        \caption{!Caption!}\label{fig:skyscanner2}
\end{figure}

%SkyscannerFig3.png (calendar)     SkyscannerFig4.png(filter options)   %SkyscannerFig5.png(alternative dates)
...
\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/TrivagoFig1a.png}
        \caption{Home screen bottom half}
    \end{subfigure}
    \qquad
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/TrivagoFig1b.png}
...
\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/TrivagoFig2.png}
        \caption{Search Results}
    \end{subfigure}%
    \qquad
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/TrivagoFig3.png}
        \caption{Hotel details}
    \end{subfigure}
    \caption{Trivago screens (caption needed?)}\label{fig:trivago2}
\end{figure}

%TrivagoFig2.png (Search results) ; TrivagoFig3.png(hotel details)
...
\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/theTrainLineFig1.png}
        \caption{Search criteria}
    \end{subfigure}%
    \qquad
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/theTrainLineFig2.png}
        \caption{Search results}
    \end{subfigure}
    \caption{theTrainLine screens (caption needed?)}\label{fig:thetrainline1}
\end{figure}

%theTrainLineFig1.png(search criteria) ; theTrainLineFig2.png(search results)
...
\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/theTrainLineFig3.png}
        \caption{Home screen}
    \end{subfigure}%
    \qquad
    \begin{subfigure}[b]{0.2\textwidth}
        \includegraphics[width=\textwidth]{img/theTrainLineFig4a.png}
        \caption{Time selection}
    \end{subfigure}
    \caption{theTrainLine.com screens (caption needed?)}\label{fig:thetrainline3}
\end{figure}

%theTrainLineFig3.png(home screen) ; theTrainLineFig4.png(Time selection)
